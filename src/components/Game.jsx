...
function Model(props) {
  const { scene} = useGLTF("f35_fighter_jet.glb");
...
function ArWing() {
  ...
  const { nodes, materials } = useLoader(GLTFLoader, "/f35_fighter_jet.glb");
  return (
    <group ref={ship}  geometry={nodes.Cube_Material001_0.geometry} material={materials['Material.001']} >
      <mesh visible >
        <meshStandardMaterial
          attach="material"
          color="white"
